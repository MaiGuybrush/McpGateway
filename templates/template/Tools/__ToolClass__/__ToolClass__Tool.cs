...
namespace McpGateway.__Department__.Tools.__ToolClass__;

[Description("查詢 __Department__ __ToolClass__ 輸入參數")]
...
[Description("__Department__ __ToolClass__ 查詢結果")]
...
public class __ToolClass__Tool
{
    ...
    [McpServerTool(Name = "__tool_name__", UseStructuredContent = true)]
    [Description("查詢 __Department__ 現場之 __ToolClass__ 處理狀態。")]
